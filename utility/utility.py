...
all_text_messages = {'Пожалуйста, укажите ваше имя:': ['Пожалуйста, укажите ваше имя:', 'Please, enter your name:'],
                     ...
                     'Документы от часов:("Да"/"Нет")': ['Документы от часов:("Да"/"Нет")', 'Documents from the clock: (“Yes”/“No”)'],
                     ...
                     'Необходимо выбрать Да/Нет': ['Необходимо выбрать Да/Нет', 'You must select Yes/No'],
